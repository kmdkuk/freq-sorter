...
1.  Download the latest `freq-sorter-extension.zip` from [Releases](https://github.com/kmdkuk/freq-sorter/releases).
2.  Unzip the file.
...
1.  [Releases](https://github.com/kmdkuk/freq-sorter/releases) ページから最新の `freq-sorter-extension.zip` をダウンロードします。
